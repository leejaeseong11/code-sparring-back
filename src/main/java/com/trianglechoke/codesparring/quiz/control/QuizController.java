...
public class QuizController {
    ...
    /* 문제에 테스트케이스 추가하기 */
    @PostMapping(value = "/testcase/{quizNo}",
    produces = "application/json;charset=UTF-8")
    public ResponseEntity<?> writeTestcase(@PathVariable Long quizNo,
                                   @RequestBody TestcaseDTO testcaseDTO) throws AddException {
    ...
    /* 테스트케이스 수정하기 */
    @PutMapping(value = "/testcase/{testcaseNo}",
    produces = "application/json;charset=UTF-8")
    public ResponseEntity<?> modifyTestcase(@PathVariable Long testcaseNo,
                                            @RequestBody TestcaseDTO testcaseDTO) throws ModifyException {
    ...
    /* 테스트케이스 삭제하기 */
    @DeleteMapping(value = "/testcase/{testcaseNo}",
            produces = "application/json;charset=UTF-8")
